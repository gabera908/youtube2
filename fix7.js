...
async function main() {
  ...
  console.log('1. Copy dist to /var/www...');
  console.log(await execCmd('mkdir -p /var/www/video && cp -r /root/youtube2/dist/* /var/www/video/ && chmod -R 755 /var/www/video'));
  console.log(await execCmd('ls -la /var/www/video'));

  console.log('2. Fix nginx config...');
...
NGINXEOF`));
  ...
  console.log('3. Test and restart nginx...');
  ...
  console.log('5. Test from external IP...');
